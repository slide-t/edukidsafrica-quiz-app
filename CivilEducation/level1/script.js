  ...
  }, 
{
  ...
  {
    "question": "Which document contains the rules and laws guiding a country?",
    "options": ["Agenda", "Charter", "Passport", "Constitution"],
    "answer": "Constitution"
  },
  {
    "question": "What is the term for a government where people vote to choose their leaders?",
    "options": ["Dictatorship", "Monarchy", "Democracy", "Military rule"],
    "answer": "Democracy"
  },
  {
    "question": "Which right gives a person the freedom to express opinions?",
    "options": ["Right to shelter", "Right to expression", "Right to vote", "Right to peace"],
    "answer": "Right to expression"
  },
  {
    "question": "Which value promotes honesty and truthfulness?",
    "options": ["Laziness", "Integrity", "Disobedience", "Corruption"],
    "answer": "Integrity"
  },
  {
    "question": "The national flag is an example of a __________.",
    "options": ["Currency", "Symbol", "Language", "Right"],
    "answer": "Symbol"
  },
  {
    "question": "Which group ensures peace and security in Nigeria?",
    "options": ["Teachers", "Doctors", "Police", "Farmers"],
    "answer": "Police"
  },
  {
    "question": "The green color on the Nigerian flag stands for ________.",
    "options": ["Wealth", "Religion", "Agriculture", "Unity"],
    "answer": "Agriculture"
  },
  {
    "question": "Who is the head of a state in Nigeria?",
    "options": ["Minister", "Governor", "Commissioner", "Chairman"],
    "answer": "Governor"
  },
  {
    "question": "What is the act of being loyal and committed to your country?",
    "options": ["Discipline", "Citizenship", "Corruption", "Patriotism"],
    "answer": "Patriotism"
  },
  {
    "question": "Which national symbol encourages unity among Nigerians?",
    "options": ["National flag", "Naira", "Passport", "Driver's license"],
  ...
  {
    "question": "The leader of a local government is called ________.",
    "options": ["Governor", "Chairman", "President", "Councillor"],
    "answer": "Chairman"
  },
  {
    "question": "An example of a fundamental human right is ________.",
    "options": ["The right to cheat", "The right to vote", "The right to steal", "The right to fight"],
    "answer": "The right to vote"
  },
  {
    "question": "Who enforces the laws in Nigeria?",
    "options": ["Legislature", "Judiciary", "Executive", "Military only"],
    "answer": "Executive"
  },
  {
    "question": "What do we call people who live together in a country?",
    "options": ["Foreigners", "Enemies", "Citizens", "Workers"],
    "answer": "Citizens"
  },
  {
    "question": "One duty of a good citizen is to ________.",
    "options": ["Disobey rules", "Pay taxes", "Destroy properties", "Steal from neighbors"],
    "answer": "Pay taxes"
  },
  {
    "question": "Why should children go to school?",
    "options": ["To play games", "To gain knowledge", "To avoid chores", "To make money"],
    "answer": "To gain knowledge"
  },
  {
    "question": "What is the full meaning of FRSC?",
    "options": ["Federal Road Safety Corps", "Federal Revenue Security Corps", "Federal Road Safety Command", "Fast Rescue and Safety Commission"],
    "answer": "Federal Road Safety Corps"
  },
  {
    "question": "What does the black shield on the Nigerian Coat of Arms stand for?",
    "options": ["Unity", "Agriculture", "Religion", "Strength"],
    "answer": "Unity"
  },
  {
    "question": "Who represents a ward in the local government?",
    "options": ["Councillor", "Senator", "Governor", "Minister"],
    "answer": "Councillor"
  },
  {
    "question": "What do we call people who break laws?",
    "options": ["Citizens", "Leaders", "Lawbreakers", "Officials"],
    "answer": "Lawbreakers"
  },
  {
    "question": "A nation that obeys law and order enjoys ________.",
    "options": ["Punishment", "Disaster", "Peace", "War"],
    "answer": "Peace"
  },
  {
    "question": "Which body ensures fair judgment in Nigeria?",
    "options": ["Executive", "Police", "Judiciary", "Senate"],
    "answer": "Judiciary"
  },
  {
    "question": "The white color in the Nigerian flag symbolizes ________.",
    "options": ["Peace", "Unity", "Religion", "Justice"],
    "answer": "Peace"
  },
  {
    "question": "What is the main responsibility of the Nigerian Army?",
    "options": ["Teaching", "Farming", "Protecting the country", "Cleaning the streets"],
    "answer": "Protecting the country"
  },
  {
    "question": "An individual who is a legal member of a country is a ________.",
    "options": ["Governor", "Minister", "Citizen", "Leader"],
    "answer": "Citizen"
  },
  {
    "question": "What does the eagle on the Nigerian Coat of Arms stand for?",
    "options": ["Peace", "Power", "Wisdom", "Corruption"],
    "answer": "Power"
  },
  {
  ...
  },
  {
    ...
    "options": ["Peace and Love", "Unity and Faith, Peace and Progress", "Hope and Faith", "Truth and Light"],
...
function goToNextLevel() {
  window.location.href = "https://slide-t.github.io/edukidsafrica-quiz-app/CivilEducation/level2/index.html";
}
